...
function checkIfDraftComplete(clan) {
    ...
    // Le banc du tête-à-tête se repêche aussi (lib/lineup.js, quotaBanc).
    const banc = clan.poolMode === 'head-to-head'
        ? Math.max(0, Math.min(5, parseInt(config.numBench, 10) || 0)) : 0;
