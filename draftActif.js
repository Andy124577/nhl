    ...
    function refreshTurnAlert() {
        ...
        if (banner) {
            if (!hasData) {
                ...
                banner.textContent = "✓ Vous avez complété tous vos choix";
            } else if (myTurn) {
                banner.className = "turn-banner your-turn";
                banner.textContent = "🎯 C'est votre tour — sélectionnez un joueur !";
            } else if (away === 1) {
                banner.className = "turn-banner waiting next";
                banner.textContent = "⏳ Vous êtes le prochain !";
            } else {
                banner.className = "turn-banner waiting";
                banner.textContent = "⏳ " + away + " choix avant votre tour";
            }
        }
...
(function () {
    function refreshOverallProgress() {
        ...
        if (fill) fill.style.width = Math.round((complete ? total : done) / total * 100) + "%";
    }
